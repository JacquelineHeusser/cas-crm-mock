    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
          <div className="bg-[#F8FAFC] rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
        ...
        {/* CTA Button - Nur Login */}
        <div className="flex justify-center items-center">
          <Link 
            href="/login"
            className="btn bg-[#0032A0] text-white hover:bg-[#005A9C] border-none px-12 py-4 text-lg rounded-full shadow-lg hover:shadow-xl transition-all"
          >
            Anmelden
          </Link>
        </div>
